...
with open("review_yelp.csv", encoding='utf-8') as f, open("reviews_weighted.txt", 'w', encoding='utf-8') as g:
    lines = f.readlines()
    ...
    for i in range(1, len(lines)-1): # from 2nd line
        ...
        if (lines[i][0].isdigit()) :
            ...
            for word4 in wordlist2:
                if word4.lower() in extremewords:
                    extword += 1
